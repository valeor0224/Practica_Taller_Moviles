package com.practica.todolist.components.login
...
import com.practica.todolist.MainActivity
import com.practica.todolist.R
import com.practica.todolist.model.LoginData
...
fun LoginFormComponent(
    ...
    Column(
        ...
        Image(
            modifier = Modifier
                .size(128.dp),
            painter = painterResource(id = R.drawable.login_logo_todo),
            contentDescription = "")
...
fun checkCredentials(loginData: LoginData, context: Context): Boolean {
    return if (loginData.isNotEmpty() && loginData.login == "user123") {
